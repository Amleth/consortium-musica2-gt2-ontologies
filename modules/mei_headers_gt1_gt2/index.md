...
Ce document vise à proposer un protocole détaillé de renseignement des métadonnées au sein des headers MEI pour l'établissement d'éditions critiques. Fixer des paramètres partagés et réconnus permettra de créer de fichiers MEI qui pourront être contrôlés, vérifiés et échangés au profit de la transparence scientifique et de l'interopérabilité. Notre objectif visera à utiliser les normes existantes dans le guide de la MEI, tout en nous appuyant sur le modèle FRBR. 
