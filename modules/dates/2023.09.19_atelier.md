...
- Les interfaces de recherche par critère temporel doivent systématiquement proposer des fourchettes dont les bornes peuvent être fixées par l'utilisateur.
- 
