...
E(crm:P4_has_type_span) --> |crm:p82a_begin_of_the_begin| F(XXX)
E(crm:P4_has_type_span) --> |crm:p81a_end_of_the_begin| F(XXX)
E(crm:P4_has_type_span) --> |crm:p81b_begin_of_the_end| F(XXX)
E(crm:P4_has_type_span) --> |crm:p82b_end_of_the_end| F(XXX)
```
