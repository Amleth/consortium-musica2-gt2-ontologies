...
B(E7_activity) --->|crm:P7_took_place_at| K(E53_place)
I(crm:E1_entity) -->|crm:P2_has_type| J(crm:E55_type<br>institution<br>aat:300026004)
I(crm:E1_entity) -->|crm:P55_has_current_location| K(crm:E53_place)
K(crm:E53_place) -->|crm:P140_assigned_attribute_to| L(crm:E13_attribute_assignement<br>geonames)
I(crm:E1_entity) -->|crm:P4_has_time_span| M(crm:E52_time_span)
