...
- Lors d'une recherche par fourchette temporelle, plusieurs modalités d'interaction entre la fourchette de recherche (FR) et les intervalles temporels des données fouillées doivent être proposées dans l'interface :

![test](https://wallpapers.com/images/featured/picture-en3dnh2zi84sgt3t.webp)

![Logique temporelle de Allen](https://www.researchgate.net/profile/Afoutni-Zoubida/publication/309419339/figure/fig9/AS:421178171772939@1477428109860/Les-relations-dAllen-entre-deux-intervalles-temporels.png "allen")
