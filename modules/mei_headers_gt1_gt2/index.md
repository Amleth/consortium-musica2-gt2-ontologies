...
L'appui sur les normes FRBR nous parait central, afin de rendre interopérables les éditions critiques encodées en MEI : la tendance de laisser le maximum de liberté à l'encodeur dans le renseignement des métadonnées dans le Header Mei mine l'interopérabilité des fichiers MEI ainsi produits, résultats de la sensibilité de chaque encodeur et de son interprétation personnelle. La création de fichiers MEI hétéroclites empêche également la trasparence scientifique d'une édition critique dont la précision du travail fait en amont de la _restitutio textus_ doit toujours être lisible et immédiatement repérable. Dòù l'urgence de fixer un protocole de saisie partagé par la communauté scientifique. Dans le cadre de l'usage des normes FRBR en MEI, il est ainsi primordial que la liste des œuvres, des expressions, des manifestations puis des items corresponde de manière fine à la _recensio_ ; le header doit être rempli de la manière la plus complète et rigoureuse possible. Notre protocole étant orienté vers la redondance, il est ainsi probable que des métadonnées soient régulièrement répétées, par exemple le nom du compositeur que nous conseillons de reinsegner à chaque niveau du modèle FRBR.
